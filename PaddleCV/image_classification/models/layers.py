...
def init_batch_norm_layer(name="batch_norm"):
    param_attr = fluid.ParamAttr(
        #name=name + '.w_0', initializer=fluid.initializer.Constant(1.0))
        name=name + '_w', initializer=fluid.initializer.Constant(1.0))
    bias_attr = fluid.ParamAttr(
        #name=name + '.b_0', initializer=fluid.initializer.Constant(value=0.0))
...
def init_fc_layer(fout, name='fc'):
    ...
    param_attr = fluid.ParamAttr(
        #name=name + '.w_0', initializer=fluid.initializer.UniformInitializer(
